			...
			<form action="" id="manage-category">
				...
				<div class="form-group">
					<label for="" class="control-label">Add Image to Content</label>
						<div>
						<img src="../user/forum/assets/img/<?php echo isset($meta['img_path']) ? $meta['img_path'] : '' ?>" alt="" class="img-field">
				...
				$.ajax({
				    ...
				    success: function(resp){
				        ...
				        if(resp.status== 1){
				        	...
				        	setTimeout(function(){
				        	location.replace('admin_home.php?page=preview_post&id='+resp.id)
