...
<div class="container-fluid">
	...
	<script>
		$('#new_post').click(function(){
				location.replace('admin_home.php?page=manage_post')
		})
		...
		function manage_post(){
			$('.edit_post').click(function(){
				location.replace('admin_home.php?page=manage_post&id='+$(this).attr('data-id'))
			})
			$('.preview_post').click(function(){
				location.replace('admin_home.php?page=preview_post&id='+$(this).attr('data-id'))
			})
