  ...
  background-size: cover;
    ...
    <?php
        if(isset($_POST['signup'])){
            ...
            $query = "INSERT INTO `requests` (`sumilang_req_id`, `sumilang_firstname`, `sumilang_lastname`, `sumilang_email`, `sumilang_password`, `sumilang_message`, `sumilang_date`) VALUES (NULL, '$firstname', '$lastname', '$email', '$password', '$message', CURRENT_TIMESTAMP)";
